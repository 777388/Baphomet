...
time6 = lambda x6: reversenum(x6)*reversenum(x6)
space6 = lambda d6: reversenum(d6)+reversenum(d6)
consciousness6 = lambda e6: reversenum(e6)/reversenum(e6)
self6 = lambda f6: reversenum(f6)-reversenum(f6)
evaluate = 0
...
print("*****"+str(evaluate)+"*****")
print("\033[32mreversenum(x5)*x5/reversenum(x5) Time:\033[0m")
Օ = print(list(map(time5, F)))
print("*****"+str(evaluate)+"*****")
print("\033[32mreversenum(d5)+d5-reversenum(d5) Space:\033[0m")
ݷ = print(list(map(space5, F)))
print("*****"+str(evaluate)+"*****")
print("\033[32mreversenum(e5)/e5*reversenum(e5) Consciousness:\033[0m")
Ʌ = print(list(map(consciousness5, F)))
print("*****"+str(evaluate)+"*****")
print("\033[32mreversenum(f5)-f5+reversenum(f5): Self\033[0m")
ɸ = print(list(map(self5, F)))
print("")
print("\033[66mBaphomet\033m")
ɘa = print(list(map(self6, F)))
ɘa = print(list(map(consciousness6, F)))
ɘa = print(list(map(space6, F)))
ɘa = print(list(map(time6, F)))
print("")    